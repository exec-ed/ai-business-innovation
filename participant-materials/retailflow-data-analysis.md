...
- 14 performance metrics per store
- Real patterns and correlations to discover

**Metrics included:**
- Store location and demographics (State, Region, Size, Age)
- Financial performance (Revenue, Costs, Profit Margin)
- Customer metrics (Count, Average Transaction, Satisfaction)
- Digital capability (Online Orders %, AI Chatbot adoption)
- Operations (Employee Count, Inventory Turnover)
...
**What AI should find:**
- Stores with AI chatbots perform better
- Older stores underperform newer stores
...
**Use this data during Dragon's Den deliberation to:**
- Validate the chatbot ROI projections
- Identify which stores should get chatbot next
- Inform your investment decision with real data
...
### Key Insight:
> "AI shows you WHAT the data says.
> YOU decide WHAT IT MEANS and WHAT TO DO about it.
>
...
- [Exercise 2 Prompt Templates](exercise-2-prompts.html) - Strategic analysis prompts
- [RetailFlow Company Overview](retailflow-company-overview.html) - Case study context
- [Dragon's Den Scenarios](exercises.html#exercise-3) - Investment proposals
