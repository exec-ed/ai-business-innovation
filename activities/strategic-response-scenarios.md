...
**Purpose**: Practice rapid strategic decision-making using Innovation Adoption Framework

---

## Exercise Overview

**Format**: Quick-fire decision scenarios
**Duration**: 15 minutes (5 min per scenario)
**Method**: Individual reflection → Pair discussion → Group vote

**Goal**: Apply frameworks to realistic strategic dilemmas with time pressure
...
**Consider:**
1. **Where does each option sit on the AI Transformation Matrix?**
   - Fast-follow = Optimize or Enhance?
   - Differentiated = Enhance or Transform?

2. **Which Innovation Adoption Phase are we in?**
   - Is this Knowledge Building, Pilot, Deployment, or Scaling?
   - What phase is the competitor in?

3. **Three Horizons Portfolio Balance**
   - Is this Horizon 1 (defend core), H2 (build new), or H3 (explore)?
   - What else is in our portfolio?
...
- If you were the CEO, which option would you choose and why?
- Does your answer change if your company is the market leader vs. challenger?
...
- **Alternative use**: Fund AI customer service chatbot instead (proven ROI)
...
### Discussion Questions
- Using the criteria table, what would you decide?
- Is 78% accuracy "good enough" or unacceptable?
- How much weight do you put on the 3 resistant stores?
...
**Consider:**
1. **Strategic Importance**: How critical is this capability to your strategy?
...
3. **Resources**: Do you have capital and talent to pioneer?
   - Deep pockets, AI talent → Can pioneer
   - Moderate resources → Fast-follower fits
   - Resource-constrained → Must wait

4. **Competitive Context**: What are competitors doing?
...
- What % of AI investment is in each horizon?
- Can you afford Horizon 3 investment?
...
**Scenario 1: Competitive Threat (5 min)**
1. Present scenario (1 min)
2. Individual quick decision + reasoning (1 min)
3. Pair discussion (2 min)
4. Quick poll + 1-2 people share rationale (1 min)

**Scenario 2: Pilot Performance (5 min)**
1. Present scenario (1 min)
2. Use Scale/Pivot/Kill criteria to decide (2 min)
3. Small group discussion (1 min)
4. Quick poll + hear different perspectives (1 min)

**Scenario 3: Emerging Tech (5 min)**
1. Present scenario (1 min)
2. Three Horizons lens (1 min)
3. Partner discussion (2 min)
4. Poll + synthesis (1 min)

### Key Learning Points to Surface

**From Scenario 1 (Competitive Response):**
- Not all competitive moves require immediate response
- "Fast follow" vs. "Differentiate" is a classic strategic choice
- Consider your competitive position (leader vs. challenger)

**From Scenario 2 (Pilot Performance):**
- Scale/Pivot/Kill is a framework, not a formula
- Mixed results require honest assessment
- Sunk costs shouldn't drive future decisions

**From Scenario 3 (Emerging Tech):**
- Innovation timing is strategic choice
- Pioneer/Fast-Follower/Laggard have different risk/reward profiles
- Must fit with overall portfolio balance (Three Horizons)

### Common Participant Questions

**Q: "What if we can't decide?"**
A: That's realistic! Often you need more information. What information would change your decision?

**Q: "Can we do multiple options?"**
A: Sometimes yes (e.g., small pioneer bet + fast-follower on another tech), but usually resources force choices.

**Q: "What's the 'right' answer?"**
A: No single right answer. It depends on your strategy, resources, competitive position. Frameworks help you decide systematically.

### Debrief Themes (Built into 4:15-4:30 wrap-up)
- Strategic agility requires frameworks + judgment
- Same scenario → different decisions based on context
- Practice builds decision-making muscle
- Frameworks prevent reactive, emotional decisions

---

## Optional: Extended Scenarios

If you have extra time or want homework assignments, use these:

### SCENARIO 4: Data Quality vs. Speed Dilemma
"Your AI project needs clean data, but cleaning will take 6 months. Competitor is launching in 3 months. Do you launch with messy data, delay for quality, or find a middle path?"

### SCENARIO 5: Build vs. Buy vs. Partner
